...
1. Use the script: `remindws [user]@[host-or-ip]:[remote-dir]`. The content of your working directory (except files excluded in `.gitignore` file) will be synced to the disrectory in provided host.
